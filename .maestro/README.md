...
| `guild-row`                                                                                                                                                                                                                 | profile                                   | The account is never in a guild. Note the trap: `assertNotVisible: guild-row` passes today and would keep passing if the id were renamed.                                                                        |
| `add-guild-button`                                                                                                                                                                                                          | profile                                   | same                                                                                                                                                                                                             |
| `owner-badge`                                                                                                                                                                                                               | profile                                   | same                                                                                                                                                                                                             |
| `join-with-code-link`                                                                                                                                                                                                       | profile                                   | same                                                                                                                                                                                                             |
...
| `selected-indicator-<id>`                                                                                                                                                                                                   | guild crest grid                          | Only after a crest is picked, which happens inside guild creation.                                                                                                                                               |
| `invite-friends-button`                                                                                                                                                                                                     | `components/profile/friends-list.tsx:106` | The has-friends header action. Needs a completed invite.                                                                                                                                                         |
| `InviteResultsSummary` (whole component)                                                                                                                                                                                    | invite sheet                              | Needs a real invite send. The invite flow deliberately never sends one — an outgoing invitation permanently flips the profile's friends section out of its empty branch and deletes the flow's own entry button. |
...
| `create-event-button`                             | scheduled quests                                             | Only asserted absent, as the empty-feed receipt.                                                                                                                                                                                     |
...
| `PermissionDeniedView` (whole view)               | invite sheet                                                 | Same denied-permission state.                                                                                                                                                                                                        |
| `social-sign-in-spinner`                          | login                                                        | Needs an OAuth attempt in flight. The social flow exists precisely to never make one.                                                                                                                                                |
| `apple-sign-in-progress`                          | login                                                        | Same. Only ever asserted absent.                                                                                                                                                                                                     |
...
`store/announcement-store.ts:118-148` and `app/(app)/index.tsx:140-190`:
